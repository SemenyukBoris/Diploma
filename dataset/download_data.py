...
#########################################################################
# Code changed by Semeniuk Borys
# Attempt of creating CRNN for musical instruments
...
if __name__ == "__main__":
    ...
    log.line("Eval")
    eval_instrument = os.path.join("metadata", "eval", "eval.csv")
    result_dir = os.path.join("audio", "eval")
    download(eval_instrument, result_dir, n_jobs=N_JOBS, chunk_size=CHUNK_SIZE)

    log.line("Train")
    train_instrument = os.path.join("metadata", "train", "train.csv")
    result_dir = os.path.join("audio", "train")
    download(train_instrument, result_dir, n_jobs=N_JOBS, chunk_size=CHUNK_SIZE)
